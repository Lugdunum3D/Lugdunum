...
static Keyboard::Key keysymToLugKey(KeySym key) {
    switch (key) {
        ...
        case XK_twosuperior:        return Keyboard::Key::Twosuperior;      // The ² key
        case XK_ampersand:          return Keyboard::Key::Ampersand;        // The & key
        case XK_eacute:             return Keyboard::Key::Eacute;           // The é key
        case XK_quotedbl:           return Keyboard::Key::QuoteDouble;      // The " key
        case XK_parenleft:          return Keyboard::Key::LParen;           // The ( key
        case XK_egrave:             return Keyboard::Key::Egrave;           // The è key
        case XK_underscore:         return Keyboard::Key::Underscore;       // The _ key
        case XK_ccedilla:           return Keyboard::Key::Ccedilla;         // The ç key
        case XK_agrave:             return Keyboard::Key::Agrave;           // The à key
        case XK_parenright:         return Keyboard::Key::RParen;           // The ) key
        case XK_dead_circumflex:    return Keyboard::Key::DeadCircumflex;   // The ^ key (dead variant)
        case XK_ugrave:             return Keyboard::Key::Ugrave;           // The ù key
        case XK_asterisk:           return Keyboard::Key::Asterisk;         // The * key
        case XK_dollar:             return Keyboard::Key::Dollar;           // The $ key
        case XK_colon:              return Keyboard::Key::Colon;            // The : key
        case XK_exclam:             return Keyboard::Key::Exclam;           // The ! key
        case XK_less:               return Keyboard::Key::Less;             // The < key
        ...
        case XK_KP_Delete:          return Keyboard::Key::Period;           // The . key (from the keypad)
