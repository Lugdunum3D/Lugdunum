...
const char * enumToStr(VkSurfaceTransformFlagBitsKHR enumVal)
{
    switch (enumVal)
    {
    ...
    default: return "ERROR: INVALID SURFACE TRANSFORM FLAG BIT TYPE";
    }
}

const char * enumToStr(VkColorSpaceKHR enumVal)
{
    switch (enumVal)
    {
    case VK_COLOR_SPACE_SRGB_NONLINEAR_KHR: return  "VK_COLOR_SPACE_SRGB_NONLINEAR_KHR";
    default: return "ERROR: INVALID COLOR SPACE ENUM";
    }
}

const char * enumToStr(VkPresentModeKHR enumVal)
{
    switch (enumVal)
    {
    ...
    default: return "ERROR: INVALID PRESENT MODE ENUM";
    }
}
...
std::vector<const char*> VkSurfaceTransformFlagsKHRToStr(VkSurfaceTransformFlagsKHR flag)
{
    std::vector<const char*> retVal;

    if (flag & VK_MEMORY_HEAP_DEVICE_LOCAL_BIT) { retVal.push_back("VK_MEMORY_HEAP_DEVICE_LOCAL_BIT"); }
    if (flag & VK_SURFACE_TRANSFORM_IDENTITY_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_IDENTITY_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_ROTATE_90_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_ROTATE_90_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_ROTATE_180_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_ROTATE_180_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_ROTATE_270_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_ROTATE_270_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR"); }
    if (flag & VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR) { retVal.push_back("VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR"); }
    return retVal;
}

std::vector<const char*> VkCompositeAlphaFlagsKHRToStr(VkCompositeAlphaFlagsKHR flag)
{
    std::vector<const char*> retVal;

    if (flag & VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR) { retVal.push_back("VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR"); }
    if (flag & VK_COMPOSITE_ALPHA_PRE_MULTIPLIED_BIT_KHR) { retVal.push_back("VK_COMPOSITE_ALPHA_PRE_MULTIPLIED_BIT_KHR"); }
    if (flag & VK_COMPOSITE_ALPHA_POST_MULTIPLIED_BIT_KHR) { retVal.push_back("VK_COMPOSITE_ALPHA_POST_MULTIPLIED_BIT_KHR"); }
    if (flag & VK_COMPOSITE_ALPHA_INHERIT_BIT_KHR) { retVal.push_back("VK_COMPOSITE_ALPHA_INHERIT_BIT_KHR"); }
    return retVal;
}

std::vector<const char*> VkImageUsageFlagsToStr(VkImageUsageFlags flag)
{
    std::vector<const char*> retVal;
