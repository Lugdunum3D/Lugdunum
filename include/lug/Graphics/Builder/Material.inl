...
inline void Material::setBaseColorTexture(Resource::SharedPtr<Resource> texture, uint32_t texCoord) {
    _baseColorTexture.texture = texture;
    _baseColorTexture.texCoord = texCoord;
}

inline void Material::setMetallicRoughnessTexture(Resource::SharedPtr<Resource> texture, uint32_t texCoord) {
    _metallicRoughnessTexture.texture = texture;
    _metallicRoughnessTexture.texCoord = texCoord;
}

inline void Material::setNormalTexture(Resource::SharedPtr<Resource> texture, uint32_t texCoord, float scale) {
    _normalTexture.texture = texture;
    _normalTexture.texCoord = texCoord;
    _constants.normalTextureScale = scale;
}

inline void Material::setOcclusionTexture(Resource::SharedPtr<Resource> texture, uint32_t texCoord, float strength) {
    _occlusionTexture.texture = texture;
    _occlusionTexture.texCoord = texCoord;
    _constants.occlusionTextureStrength = strength;
}

inline void Material::setEmissiveTexture(Resource::SharedPtr<Resource> texture, uint32_t texCoord) {
