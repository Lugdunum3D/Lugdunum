...
public:
    ...
    void setDirection(const Math::Vec3f& direction, const Math::Vec3f& localDirectionVector, TransformSpace space = TransformSpace::Local);

    void lookAt(const Math::Vec3f& targetPosition, const Math::Vec3f& localDirectionVector, TransformSpace space = TransformSpace::Local);

    // TODO: Look at with up vector
